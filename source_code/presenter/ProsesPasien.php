...
class ProsesPasien implements KontrakPresenter
{
	...
	function prosesTambahData($data_baru)
	{
		try {
			//mengambil data di tabel pasien
			$this->tabelpasien->open();
			$this->tabelpasien->addPasien($data_baru);
	...
	function prosesUbahData($data_baru)
	{
		try {
			//mengambil data di tabel pasien
			$this->tabelpasien->open();
			$this->tabelpasien->editPasien($data_baru);
